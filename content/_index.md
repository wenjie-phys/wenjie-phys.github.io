...
<a class="home-profile-link" href="mailto:wenjieji@westlake.edu.cn">
  <svg class="home-profile-icon" aria-hidden="true" viewBox="0 0 512 512">
    <path d="M502.3 190.8c3.9-3.1 9.7-.2 9.7 4.7V400c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V195.6c0-5 5.7-7.8 9.7-4.7 22.4 17.4 52.1 39.5 154.1 113.6 21.1 15.4 56.7 47.8 92.2 47.6 35.7.3 72-32.8 92.3-47.6 102-74.1 131.6-96.3 154-113.7zM256 320c23.2.4 56.6-29.2 73.4-41.4 132.7-96.3 142.8-104.7 173.4-128.7 5.8-4.5 9.2-11.5 9.2-18.9v-19c0-26.5-21.5-48-48-48H48C21.5 64 0 85.5 0 112v19c0 7.4 3.4 14.3 9.2 18.9 30.6 23.9 40.7 32.4 173.4 128.7 16.8 12.2 50.2 41.8 73.4 41.4z" />
  </svg>
  <span>Email</span>
</a>

<a class="home-profile-link" href="https://www.google.com/maps/place/Hangzhou,+Zhejiang,+China" target="_blank" rel="noopener noreferrer">
  <svg class="home-profile-icon" aria-hidden="true" viewBox="0 0 384 512">
    <path d="M172.3 501.7C27 291 0 269.4.0 192 0 86 86 0 192 0s192 86 192 192c0 77.4-27 99-172.3 309.7-9.5 13.8-29.9 13.8-39.4.0zM192 272c44.2.0 80-35.8 80-80s-35.8-80-80-80-80 35.8-80 80 35.8 80 80 80z" />
  </svg>
  <span>Hangzhou &middot; China</span>
</a>
</div>
